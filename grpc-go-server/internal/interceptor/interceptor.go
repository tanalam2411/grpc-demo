...
import (
	...
	hello_proto "github.com/tanalam2411/grpc-demo/protogen/go/hello"
...
func (s *InterceptedServerStream) RecvMsg(msg any) error {
...
func (s *InterceptedServerStream) SendMsg(msg any) error {
